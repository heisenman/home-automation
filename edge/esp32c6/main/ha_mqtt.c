#include "ha_mqtt.h"
#include "ha_sntp.h"
#include "ha_gatt.h"       // shared SwitchBot GATT-history client (ADR-0020) — replaces local gatt_history.c
#include "gatt_exec.h"
#include "ha_ota.h"
#include "ha_relay.h"
#include "ha_reach.h"
...
#define HA_FW_VERSION "v16-ledoff"  // bump to prove an OTA swapped the running image
#endif
