...
| Module | esp32c3 | esp32c6 | esp32s3-eth | s3-shades | d1001-panel |
|--------|:-----:|:-----:|:-----:|:-----:|:-----:|
| `app_main` | fork | fork | fork | fork | fork |
| `ha_dout` | — | — | — | shared | — |
| `ha_gaposa` | — | — | — | shared | — |
| `ha_config` | shared | shared | shared | shared | shared |
| `ha_wifi` | shared | shared | shared | shared | — |
| `ha_eth` | — | — | shared | — | — |
| `ha_sntp` | shared | shared | shared | shared | — |
| `ha_mqtt` | shared | shared | shared | shared | — |
...
| `ha_ota` | shared | shared | shared | shared | shared |
| `ha_led` | — | — | shared | — | — |
