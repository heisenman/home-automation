...
#include "driver/i2c_master.h"   // ADAPTED (ha_audio): new i2c_master driver, see es8311.c header note
 ...
 *
 * @param[in] bus      I2C master bus handle (new driver) the ES8311 sits on (D1001: bsp_i2c1())
 * @param[in] dev_addr I2C device address of ES8311 (0x18 on the D1001)
 *
 * @return
 *     - NULL Fail
 *     - Others Success
