...
// Battery/temp/charge live in the shared ha_battery component now; it needs the PCA9535 +
// I2C-1 handles this BSP owns, so expose them (app_main injects them into ha_battery_cfg).
esp_io_expander_handle_t bsp_io_expander(void) { return io_expander; }
i2c_master_bus_handle_t  bsp_i2c1(void)        { return s_i2c1; }
