...
// including "ble_scan.h" unchanged so they stay byte-identical to the not-yet-migrated
// c3/s3 forks; this just forwards to the shared header. Retire once all nodes migrate.
